...
parser = argparse.ArgumentParser(description="Save MongoDB database collections data to xlsx")

parser.add_argument("--host", required=False, default="127.0.0.1", help="MongoDB host")
parser.add_argument("--port", required=False, default=27017, help="MongoDB port")
